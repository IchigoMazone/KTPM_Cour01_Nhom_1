...
const adminNotifications: NotificationItem[] = [
  ...
  {
    icon: FileText,
    title: "Báo cáo doanh thu ngày đã sẵn sàng",
    description: "File Excel đã được tạo và gửi cho tài khoản quản lý.",
    time: "1 giờ trước",
    tone: "success",
    label: "Báo cáo",
    orderCode: "BC-DOANH-THU",
    customer: "Quản lý cửa hàng",
    service: "Báo cáo doanh thu ngày",
    amount: "Excel",
    pickupTime: "22:00 mỗi ngày",
    address: "Email tài khoản",
    confirmLabel: "Đã nhận báo cáo",
  },
  {
    icon: FileText,
    title: "Nhắc kiểm tra báo cáo công nợ tuần",
    description: "Có 3 khách hàng còn công nợ cần đối soát trước khi xuất file.",
    time: "Hôm nay",
    tone: "warning",
    label: "Công nợ",
    orderCode: "BC-CONG-NO",
    customer: "Thu ngân",
    service: "Báo cáo công nợ tuần",
    amount: "3 khoản cần thu",
    pickupTime: "Thứ 2 hàng tuần",
    address: "Tài khoản thu ngân",
    confirmLabel: "Đã đối soát",
  },
];
